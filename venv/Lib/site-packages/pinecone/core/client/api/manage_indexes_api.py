    ...
    def __init__(self, api_client=None):
        ...
        def __configure_index(
            ...
            **kwargs
            ...
            >>> thread = api.configure_index(indexname, configure_index_request, async_req=True)
            >>> result = thread.get()

            Args:
                indexname (str): The name of the index to configure
        ...
        self.configure_index = _Endpoint(
            settings={
                ...
                'endpoint_path': '/indexes/{indexname}',
        ...
        def __delete_index(
            ...
            **kwargs
            ...
            >>> thread = api.delete_index(indexname, async_req=True)
            >>> result = thread.get()

            Args:
                indexname (str): The name of the index to delete
        ...
        def __describe_index(
            ...
            **kwargs
            ...
            >>> thread = api.describe_index(indexname, async_req=True)
            >>> result = thread.get()

            Args:
                indexname (str): The name of the index to be described
